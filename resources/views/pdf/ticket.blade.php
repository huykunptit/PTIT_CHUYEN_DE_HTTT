        ...
        <div class="ticket-content">
            ...
            <div class="info-section">
                <div class="info-row">
                    ...
                    <div class="info-value">{{ $ticket->booking->showtime->movie->title }}</div>
                </div>
                <div class="info-row">
                    <div class="info-label">Rạp:</div>
                    <div class="info-value">{{ $ticket->booking->showtime->room->cinema->name }}</div>
                </div>
                <div class="info-row">
                    <div class="info-label">Phòng:</div>
                    <div class="info-value">{{ $ticket->booking->showtime->room->name }}</div>
                </div>
                <div class="info-row">
                ...
                <div class="info-row">
                    ...
                    <div class="info-value">{{ $ticket->booking->showtime->date->format('d/m/Y') }}</div>
                </div>
                <div class="info-row">
                ...
                <div class="info-row">
                    ...
                    <div class="info-value">{{ $ticket->booking->user->name }}</div>
                </div>
                @endif
                <div class="info-row">
                    <div class="info-label">Mã đặt vé:</div>
                    <div class="info-value">{{ $ticket->booking->booking_code }}</div>
                </div>
            </div>
